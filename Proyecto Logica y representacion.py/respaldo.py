...
#while para que no se rompa el codigo cuando se ingrese una opción diferente a si o no.
          while True:
               ...
               print ("═══"*25)  
               if decision =="si" or decision=="shi" or decision=="sii" or decision=="sip"   :
                break
               elif decision=="no" or decision=="noo" or decision=="nooo" or decision=="nop":
    ...
    # while para eliminar productos de la mesa.
     while True:
        try:    
            ...
            print("═══" * 25)
            # limitando los numeros de producto a eliminar.
            ...
            while True:
                ...
                if decision in ["si", "shi", "s", "sip"]:
                    # si dice que sí, continuar el ciclo para eliminar más productos
                    break
                elif decision in ["no", "noo", "n", "nop"]:
                    # si dice que no, salir del ciclo de eliminación
                    eliminar_producto = False
                    break
                else:
                    print("❌ Opción inválida, escriba (Si/No)")
            # Si decide no eliminar más productos, se rompe el ciclo exterior
